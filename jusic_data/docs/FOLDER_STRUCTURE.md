...
- 배치 파일은 자동으로 루트 디렉토리로 이동합니다 (`cd /d "%~dp0\.."`)

## 변경 사항

- 모든 import 경로가 상대 경로에서 절대 경로로 변경되었습니다
- 파일 경로가 루트 기준으로 설정되었습니다
- 각 폴더의 `__init__.py` 파일이 필요하면 추가할 수 있습니다
